...
(function () {
  ...
  const EN = {
    ...
    'lv': 'Lv {n}',
    'prod.price': '{price} each · delivery every {sec}s',
    'prod.stock': 'shelf {a}/{b} · crate {c}/{d}',
  ...
  const ZH = {
    ...
    'prod.later': '稍后解锁',
    'prod.price': '每件 {price} · 每 {sec} 秒产出一个',
    'prod.stock': '货架 {a}/{b} · 库存 {c}/{d}',
    'prod.next': ' · 下个奖励 Lv {n}',
    'prod.maxed': ' · 已满级',
    'btn.upgrade': '升级 ×{n}',
  ...
  const TW = {
    ...
    'prod.later': '稍後解鎖',
    'prod.price': '每件 {price} · 每 {sec} 秒產出一個',
    'prod.stock': '貨架 {a}/{b} · 庫存 {c}/{d}',
    'prod.next': ' · 下個獎勵 Lv {n}',
    'prod.maxed': ' · 已滿級',
    'btn.upgrade': '升級 ×{n}',
  ...
  const MS = {
    ...
    'prod.price': '{price} sekeping · keluar setiap {sec}s',
    'prod.stock': 'rak {a}/{b} · stok {c}/{d}',

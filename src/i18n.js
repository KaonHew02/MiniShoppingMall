...
(function () {
  ...
  const EN = {
    ...
    'staff.baristaOn': 'Working the bar — machines brew on their own',
    'staff.baristaOff': 'Otherwise you must stand at the machine',
    'staff.server': 'Server',
    'staff.serverOn': 'Running drinks out to the tables',
    'staff.serverOff': 'Otherwise you carry every drink yourself',
    ...
    'toast.server': 'Server hired — drinks find their own way over',
  ...
  const ZH = {
    ...
    'staff.barista': '咖啡师',
    'staff.baristaOn': '在吧台工作 — 设备自己出品',
    'staff.baristaOff': '否则你必须站在设备旁',
    'staff.server': '服务员',
    'staff.serverOn': '负责把饮品送到客人手上',
    'staff.serverOff': '否则每一杯都得你自己送',
    'staff.cleaner': '清洁工',
    'staff.cleanerOn': '客人一走就收拾桌子',
    'staff.cleanerOff': '脏桌子没人能坐，还会少收小费',
    'toast.barista': '已雇用咖啡师 — 吧台自动出品',
    'toast.server': '已雇用服务员 — 饮品自动送达',
  ...
  const TW = {
    ...
    'staff.barista': '咖啡師',
    'staff.baristaOn': '在吧台工作 — 設備自己出品',
    'staff.baristaOff': '否則你必須站在設備旁',
    'staff.server': '服務生',
    'staff.serverOn': '負責把飲品送到客人手上',
    'staff.serverOff': '否則每一杯都得你自己送',
    'staff.cleaner': '清潔員',
    'staff.cleanerOn': '客人一走就收拾桌子',
    'staff.cleanerOff': '髒桌子沒人能坐，還會少收小費',
    'toast.barista': '已雇用咖啡師 — 吧台自動出品',
    'toast.server': '已雇用服務生 — 飲品自動送達',
  ...
  const MS = {
    ...
    'staff.barista': 'Barista',
    'staff.baristaOn': 'Bekerja di bar — mesin jalan sendiri',
    'staff.baristaOff': 'Jika tidak, anda perlu berdiri di mesin',
    'staff.server': 'Pelayan',
    'staff.serverOn': 'Menghantar minuman ke meja',
    'staff.serverOff': 'Jika tidak, anda hantar setiap cawan sendiri',
    ...
    'toast.server': 'Pelayan diambil — minuman sampai sendiri',
